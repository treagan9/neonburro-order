    ...
    if (isOpen) {
      ...
      const interval = setInterval(function() {
        ...
        confetti(Object.assign({}, defaults, {
          ...
          colors: [colors.brand.primary, colors.accent.green]
        }));
        confetti(Object.assign({}, defaults, {
          particleCount,
              ...
              <VStack spacing={{ base: 6, md: 8 }} p={{ base: 8, md: 10 }} position="relative">
                ...
                <VStack spacing={2}>
                  ...
                  <Text 
                    ...
                    textAlign="center"
                  >
                    Thank you, {formData.firstName}. We've received your order.
                  </Text>
                </VStack>
                ...
                >
                  <VStack spacing={3} align="stretch">
                    ...
                    <HStack justify="space-between">
                      <Text color="white" fontWeight="600">Total</Text>
                      <Text 
                ...
                <VStack spacing={3} width="100%">
                  <HStack spacing={2} color="gray.400" fontSize="sm">
                    <FiClock size={16} />
                    <Text>We'll contact you within 2 hours to arrange payment</Text>
                  </HStack>
